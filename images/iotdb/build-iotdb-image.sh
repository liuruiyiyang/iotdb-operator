...
checkVersion()
{
	...
	echo "Version $1 illegal, it should be X.X.X format(e.g. 0.9.0), please check released versions in 'https://dist.apache.org/repos/dist/release/iotdb/'"
    exit 2
}
...
IOTDB_VERSION=$1
DOCKERHUB_REPO=2019liurui/iotdb-iotdb
